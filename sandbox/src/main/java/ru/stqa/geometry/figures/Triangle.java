...
public record Triangle (double sideA, double sideB, double sideC) {
    ...
    public boolean equals(Object o) {
        ...
        return (Double.compare(this.sideA, triangle.sideA) == 0 && Double.compare(this.sideB, triangle.sideB) == 0 && Double.compare(this.sideC, triangle.sideC) == 0)
                ...
                || (Double.compare(this.sideC, triangle.sideA) == 0 && Double.compare(this.sideB, triangle.sideB) == 0 && Double.compare(this.sideA, triangle.sideC) == 0)
                || (Double.compare(this.sideB, triangle.sideA) == 0 && Double.compare(this.sideA, triangle.sideB) == 0 && Double.compare(this.sideC, triangle.sideC) == 0);
    }
